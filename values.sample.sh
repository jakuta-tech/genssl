...
export ca_protect=${ca_protect:-"no"}
export ca_name=${ca_name:-"FlorentPeterschmitt"}
export ca_days=${ca_days:-730}
export ca_subj=${ca_subj:-"/C=${ca_country_code}/ST=${ca_state}/L=${ca_locality}/O=${ca_org}/OU=${ca_org_unit}/CN=${ca_common_name}/emailAddress=${ca_mail}"}
...
export protect=${protect:-"no"}
export days=${days:-365}
export subj=${subj:-"/C=${country_code}/ST=${state}/L=${locality}/O=${org}/OU=${org_unit}/CN=${common_name}/emailAddress=${mail}"}
